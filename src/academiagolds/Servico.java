...
public class Servico extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        novoServico dialog = new novoServico(null, rootPaneCheckingEnabled);
    ...
    public void carregaTable() {
        try {
            ...
            String query = "SELECT * FROM servico WHERE modalidade LIKE ?";
            ...
            while (rs.next()) {
                model.addRow(new Object[]{rs.getString("ID"), rs.getString("modalidade"), rs.getString("valor")});
            }
    ...
    private void Excluir() {
        if (jTable1.getSelectedRow() == -1) {
            ...
            int showConfirmDialog = JOptionPane.showConfirmDialog(this, "A Exclusão do Servico resultará na Exclusão\n dos seus dados relacinados \n Deseja continuar?");
    ...
    private void Editar() {
        if (jTable1.getSelectedRow() == -1) {
            ...
            for (int i = 0; i < jTable1.getColumnCount(); i++) {
                dados.add((String) jTable1.getValueAt(jTable1.getSelectedRow(), i));
            }

            novoServico dialog = new novoServico(null, rootPaneCheckingEnabled, dados);
            dialog.setVisible(true); //Chama a dialog
            carregaTable();
        }
    }
